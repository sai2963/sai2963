...
[![My Skills](https://skillicons.dev/icons?i=git,github,mysql,c,selenium,vscode,linux,bootstrap,java,python,html,css,javascript,nodejs,expressjs,postman,tailwind,mongodb,babel,react,nextjs,firebase,vite,fastapi,csharp&perline=7)](https://skillicons.dev)
